...
const ROYALTY_ADDRESS = "0x64d05C6c5E6d5e5754c03F1ead0BEC85475f0b12"; // Address that will receive the royalty
const BASE_URI = null; // only update if you want to manually set the base uri
const PREREVEAL_TOKEN_URI = null; // only update if you want to manually set the prereveal token uri
const PRESALE_WHITELISTED_ADDRESSES = ["0x64d05C6c5E6d5e5754c03F1ead0BEC85475f0b12"]; // only update if you want to manually set the whitelisted addresses
